...
class YXUserCenterVC: YXBaseVC {
    ...
    lazy var secArr: [Dictionary<String, AnyObject>] = {

        var secArr = [Dictionary<String, AnyObject>]()
        var dic = Dictionary<String, AnyObject>()
        
        dic = ["title":"我的订单", "tag":YXUserCenterVCSecEnum.yxMyOrder, "valueArr":self.orderArr] as Dictionary<String, AnyObject>
        secArr.append(dic)
        
        dic = ["title":"我的仓库", "tag":YXUserCenterVCSecEnum.yxMyWarehouse, "valueArr":[]] as Dictionary<String, AnyObject>
        secArr.append(dic)
        
        dic = ["title":"广告", "tag":YXUserCenterVCSecEnum.yxMyAdverting, "valueArr":[]] as Dictionary<String, AnyObject>
        secArr.append(dic)
        
        dic = ["title":"模块", "tag":YXUserCenterVCSecEnum.yxMyModule, "valueArr":[]] as Dictionary<String, AnyObject>
        secArr.append(dic)
        
        return secArr
    }()
    
    lazy var orderArr: [Dictionary<String, AnyObject>] = {
        
        var orderArr = [Dictionary<String, AnyObject>]()
        var dic = Dictionary<String, AnyObject>()
        
        dic = ["title":"待付款", "tag":YXUserCenterVCSecOrderEnum.yxBePaid, "count":0, "icon":"YXUserCenterAllOrderImg"] as Dictionary<String, AnyObject>
        orderArr.append(dic)
        
        dic = ["title":"待发货", "tag":YXUserCenterVCSecOrderEnum.yxBeShipped, "count":0, "icon":"YXUserCenterBeSend"] as Dictionary<String, AnyObject>
        orderArr.append(dic)
        
        dic = ["title":"待收货", "tag":YXUserCenterVCSecOrderEnum.yxBeReceived, "count":0, "icon":"YXUserCenterBeReceivedImg"] as Dictionary<String, AnyObject>
        orderArr.append(dic)
        
        dic = ["title":"待评价", "tag":YXUserCenterVCSecOrderEnum.yxBeEvaluate, "count":0, "icon":"YXUserCenterEvaluateImg"] as Dictionary<String, AnyObject>
        orderArr.append(dic)
        
        dic = ["title":"售后", "tag":YXUserCenterVCSecOrderEnum.yxAfterSale, "count":0, "icon":"YXUserCenterEvaluateImg"] as Dictionary<String, AnyObject>
        orderArr.append(dic)
