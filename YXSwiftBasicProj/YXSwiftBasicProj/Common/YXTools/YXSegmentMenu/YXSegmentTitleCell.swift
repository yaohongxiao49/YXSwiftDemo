...
public class YXSegmentTitleCell: UICollectionViewCell {
    
    private var config: YXSegmentTitleView.Configuration!
...
fileprivate extension YXSegmentTitleCell {
