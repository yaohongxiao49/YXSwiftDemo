...
/** 选中page */
@objc public protocol YXSegmentTitleViewDelegate: NSObjectProtocol {
    
    @objc optional func segmentTitleView(_ page: YXSegmentTitleView, at index: Int)
...
public class YXSegmentTitleView: UIView {
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(YXSegmentTitleCell.classForCoder(), forCellWithReuseIdentifier: NSStringFromClass(YXSegmentTitleCell.classForCoder()))
...
fileprivate extension YXSegmentTitleView {
    ...
    func updateConfiguration() {
        ...
        for title in self.titles {
            let size = self.yxTextSize(title, font: self.config.titleNormalFont)
    ...
    func setSelectedCell(cell: YXSegmentTitleCell?, at indexPath: IndexPath, animated: Bool) {
        ...
        let seleCell = self.collectionView.cellForItem(at: seleIndexPath) as? YXSegmentTitleCell
        for subCell in self.collectionView.visibleCells {
            if subCell == cell {
                (subCell as? YXSegmentTitleCell)?.updateCellTitle(isChecked: true, animated: animated)
            }
            else if subCell == seleCell {
                (subCell as? YXSegmentTitleCell)?.updateCellTitle(isChecked: false, animated: animated)
            }
            else {
                (subCell as? YXSegmentTitleCell)?.updateCellTitle(isChecked: false, animated: false)
            }
        }
    ...
    func setSelectedCell(at index: Int, animated: Bool) {
        ...
        let cell = collectionView.cellForItem(at: indexPath) as? YXSegmentTitleCell
    ...
    func scrollTo(selectIndex: Int, willSelectIndex: Int, progress: CGFloat) {
        ...
        let seleCell = collectionView.cellForItem(at: seleIndexPath) as? YXSegmentTitleCell
        let willCell = collectionView.cellForItem(at: willIndexPath) as? YXSegmentTitleCell
...
extension YXSegmentTitleView: UICollectionViewDataSource {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell: YXSegmentTitleCell = collectionView.dequeueReusableCell(withReuseIdentifier: NSStringFromClass(YXSegmentTitleCell.classForCoder()), for: indexPath) as! YXSegmentTitleCell
...
extension YXSegmentTitleView: UICollectionViewDelegateFlowLayout {
    ...
    public func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if self.delegate?.responds(to: #selector(self.delegate?.segmentTitleView(_:at:))) ?? false {
